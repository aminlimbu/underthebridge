...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark p-md-2">
    ...
    <div class="container-fluid">
        <a href="<?php echo URLROOT; ?>" class="navbar-brand">Under The Bridge</a>
        <!-- menu toggler -->
        <button class="navbar-toggler ms-auto" type="button" data-bs-target="#navbarNav" data-bs-toggle="collapse" aria-controls="navbarNav" aria-expanded="false" aria-lable="Toggle Navbar">
